...
public class LockDrawer : MonoBehaviour
{
    ...
    public GameObject DrawerToUnlock; // Reference to the GameObject to disable
    ...
    private void Start()
    {
        ...
        drawerInteract = DrawerToUnlock.GetComponent<DrawerInteract>();

        // Disable the MoveObject method initially
        drawerInteract.DisableMoveObject();
    }
    ...
    private void Unlock()
    {
        ...
        // Enable the MoveObject method in the DrawerInteract script
        drawerInteract.EnableMoveObject();
    }
